...
<html lang="en">
	...
	<body>
		<?php  header("Location:/thinkphp_3.2.3_core/Public/dokuwiki/doku.php?id=autodesign:".urlencode($title)); ?>
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs" style="position:fixed;width:100%;z-index: 1028;">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="/thinkphp_3.2.3_core/Home/Autodesign/index">自动化设计</a>
							</li>
							<li class="active"><?php echo ($detailinfoArr[0]["title"]); ?></li>
						</ul><!-- .breadcrumb -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h2 class="header smaller lighter blue">
									<?php echo ($detailinfoArr[0]["title"]); ?>
									&nbsp;<small>创建时间:<?php echo ($detailinfoArr[0]["create_time"]); ?></small>
								</h2>
							</div><!-- /.col -->
						</div>
						<div class="row">
							<div class="col-xs-12">
								<div>
									<pre><font size=+1 face="宋体"><?php echo ($detailinfoArr[0]["content"]); ?></font></pre>
								</div>
							</div>
						</div>
