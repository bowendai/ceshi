...
<html lang="en">
	<head>
		...
		<!--[if IE 7]>
		  <link rel="stylesheet" href="/thinkphp_3.2.3_core/Public/assets/css/font-awesome-ie7.min.css" />
		<![endif]-->
		...
		<!--[if lte IE 8]>
		  <link rel="stylesheet" href="/thinkphp_3.2.3_core/Public/assets/css/ace-ie.min.css" />
		<![endif]-->
		...
		<!--[if lt IE 9]>
		<script src="/thinkphp_3.2.3_core/Public/assets/js/html5shiv.js"></script>
		<script src="/thinkphp_3.2.3_core/Public/assets/js/respond.min.js"></script>
		<![endif]-->
	</head>
...
<![endif]-->
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='/thinkphp_3.2.3_core/Public/assets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
		...
		<!--[if lte IE 8]>
		  <script src="/thinkphp_3.2.3_core/Public/assets/js/excanvas.min.js"></script>
		<![endif]-->
