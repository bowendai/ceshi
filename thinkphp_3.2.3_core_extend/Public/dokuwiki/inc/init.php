...
if(!headers_sent() && !defined('NOSESSION')) {
    ...
    session_set_cookie_params(DOKU_SESSION_LIFETIME, DOKU_SESSION_PATH, DOKU_SESSION_DOMAIN, ($conf['securecookie'] && dokuwiki_is_ssl()), true);
    session_start();
 ...
 */
 ...
 //此处和thinkphp中函数重名 故前面加了 dokuwiki_
function dokuwiki_is_ssl(){
